...
public class SunVoxLib
{
	...
	public static native int rewind( int slot, int t );
	public static native int volume( int slot, int vol );
	public static native int send_event( int slot, int channel_num, int note, int vel, int module, int ctl, int ctl_val );
